...
mod token {
    ...
    mod e2e_tests {
        ...
        async fn default_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            // Then
            let get = build_message::<TokenRef>(contract_account_id.clone())
                .call(|token| token.get());
        ...
        async fn it_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            // When
            let flip = build_message::<TokenRef>(contract_account_id.clone())
                .call(|token| token.flip());
